...
const AddToys = () => {
  ...
  const dollsDataSubmitHandler = (event) => {
  ...
  return (
    <div>
        ...
        <br />
        <span className="font-bold text-slate-500">Seller Add Doll</span>
      </h1>
      <div className="bg-green-300 md:p-20 p-10 mb-20 rounded-lg">
        <form onSubmit={dollsDataSubmitHandler} className=" rounded">
